...
const BLOG = {
  AUTHOR: '无岸海', // 作者
  BIO: '一个普通的医学生💊', // 作者简介
  LINK: 'https://blog.noshore.cn', // 网站地址
  KEYWORDS: '无岸海, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '5c39ce223096482f818a86ebcf57ce81', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'before1999@foxmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/noshore', // 你的github个人主页
